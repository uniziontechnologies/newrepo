...
?>
          ...
          <h4><?php echo $lang_ip_bill_report_heading; ?></h4>
								 ...
								 for($i=0;$i<count($billInfo);$i++) {
								  ...
								  ?>
									<tr class="rowstyle">
			                            ...
			                            <td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[$i][11];?></font></td>
										<td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[$i][12];?></font></td>
										<td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[$i][13];?></font></td>
										<td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[$i][15];?></font></td>
										<td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[$i][14];?></font></td>
		                                    
									</tr>
					<?php                  
					                     $total=$total+$billInfo[$i][11];
					                     $totalcash=$totalcash+$billInfo[$i][13];
					                     $totalcard=$totalcard+$billInfo[$i][15];
					                     $balance=$balance+$billInfo[$i][14];
					                            }
