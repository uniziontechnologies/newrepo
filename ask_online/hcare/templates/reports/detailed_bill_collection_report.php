...
function submitform(){  	
		 ...
		 if(document.bill_collection.from_time.value == "" && document.bill_collection.to_time.value != ""){
		  ...
		  return false;
   		  ...
   		  document.bill_collection.action="../../lib/controllers/centralController.php?module=Report&sub_module=detailed_bill_collection_report";
   ...
   function download_pdf(){
   		$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Detailed Bill Collection Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
	...
	<section class="content">
	 <div class="DONTPrint">				 
	   <div class="box box-info">
			...
			<h4 ><?php echo $lang_daily_collection." ".$lang_report." ".ucfirst(strtolower($lang_user))." ".$lang_categorywise; ?> From <?php echo $post['from_date']. " ".$post['from_time'];?> To <?php echo $post['to_date']." ".$post['to_time'];?>
		...
		echo "From ".$post['from_date']. " ".$post['from_time'];} if (!empty($post['to_date'])) {
			echo "To ".$post['to_date']." ".$post['to_time'];
				...
				?>
						...
						<td><?php echo round($dailyInfo[$i][1]);?></td>
						<td><?php if ($i!=3) {
							echo round($dailyInfo[$i][2]);
						}else{echo round($dailyInfo[$i][15]);} ?></td>
						<td><?php if ($i!=3) {
							echo round($dailyInfo[$i][16]);
						}else{echo round($dailyInfo[$i][18]);} ?></td>
						<td><?php echo round($dailyInfo[$i][3]);?></td>
						<td><?php echo round($dailyInfo[$i][4]);?></td>
						<td><?php echo round($dailyInfo[$i][5]);?></td>
						<td class="text-center"><?php echo round($total_cash_paid[$i]);?></td>
						<td class="text-center"><?php echo round($total_card_paid[$i]);?></td>
						<td class="text-center"><?php echo round($total_upi_paid[$i]);?></td>
				        <td><?php echo round($dailyInfo[$i][7]);?></td>
						<td><?php echo round($dailyInfo[$i][8]);?></td>
				...
				<tr>
				     ...
				     <td class="text-center"><b><?php echo round($credit_paid_cash); ?></b></td>
				     <td class="text-center"><b><?php echo round($credit_paid_card); ?></b></td>
				      <td class="text-center"><b><?php echo round($credit_paid_upi); ?></b></td>
	 ...
	 <input type="hidden" name="page_name" id="detailed_bill_collection_report" value="detailed_bill_collection_report" />
<?php
