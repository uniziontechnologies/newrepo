...
<script>
   ...
   function submitform(action,id){
		...
		setAction(action,id);
   		document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=patient_report";
    ...
    function clear_form(){
   		...
   		window.location.href = "../../lib/controllers/centralController.php?module=Report&sub_module=patient_report";
...
<form name="patients" id="form"  method="post" action=""> 
 ...
 <section class="content-header">
	...
	<section class="content">
				...
				<table class="table table-striped">
							...
							<?php echo $lang_user; ?> </td>
								...
								<tr>
									...
									<?php echo $lang_health_checkup; ?>&nbsp;&nbsp;<input type="checkbox" name="health_checkup" value="health_checkup"  onkeypress="nextField(event.keyCode,remarks)"/>
	 ...
	 <input type="hidden" name="page_name" id="patient_report" value="patient_report" />
