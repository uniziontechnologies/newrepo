...
function submitform(action,id){
  ...
  if(action =="CLEAR"){
			...
			document.patients.to_date.value='';
   		    ...
   		    document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=pharmacy_receivings_return_report";
   ...
   function download_pdf(){
   	$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Pharma Recievings Return Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
		...
		<section class="content">
			...
			<div>
			    <div>
                	<h4> 
                	    ...
                	    ?>
						<?php echo $lang_receivings_return_report." From ".$from_date." To ".$to_date; ?>
			...
			<div class="box box-info">
               ...
               <div class="box-body">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo $lang_receivings_return_report; ?> From <?php if (!empty($post['from_date'])) {
		echo $post['from_date'];} if (!empty($post['to_date'])) {
			echo " To ".$post['to_date'];
				  ...
				  <tr>
					 ...
					 <th width="3%" class="center"><a href="#"><?php echo $lang_foc; ?></a></th>
					 <th width="3%" class="center"><a href="#"><?php echo $lang_buyp; ?></a></th>
					 <th width="3%" class="center"><a href="#"><?php echo $lang_discount; ?></a></th>
...
?>
	  ...
	  <input type="hidden" name="page_name" id="pharmacy_receivings_return_report" value="pharmacy_receivings_return_report" />
