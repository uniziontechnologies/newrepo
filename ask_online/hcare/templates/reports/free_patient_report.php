	   ...
	   //Date range picker
        $('#from_date').datepicker();
		 $('#to_date').datepicker();
		  ...
		  // var new_row="<tr><td><b>NEW:&nbsp;&nbsp;"+$('#new').val()+"</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>VISIT:&nbsp;&nbsp;"+$('#visit').val()+"</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>FREE:&nbsp;&nbsp;"+$('#free').val()+"</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>HEALTHCHECKUP:&nbsp;&nbsp;"+$('#health_checkup').val()+"</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><b>Dr Fee:&nbsp;&nbsp;"+$('#dr_fee').val()+"</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Reg Fee:&nbsp;&nbsp;"+$('#reg_fee').val()+"</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Card fee:&nbsp;&nbsp;"+$('#card_fee').val()+"</td></tr>";
...
<script>
   ...
   function submitform(action,id){
		...
		setAction(action,id);
   		document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=free_patient_report";
	...
	<section class="content">
	 <div class="DONTPrint">				 
	   <div class="box box-info">
				...
				<table class="table table-striped">
							...
							<?php echo $lang_user; ?> </td>
								<td id="noborder" ><select name="user" id="user"   onkeypress="nextField(event.keyCode,inc)" /> 		
									...
									<?php echo $lang_health_checkup; ?>&nbsp;&nbsp;<input type="checkbox" name="health_checkup" value="1"  onkeypress="nextField(event.keyCode,remarks)"/>
			...
			<h4 ><?php echo "FREE PATIENTS"." ".$lang_list; ?> From 
			       <?php if (!empty($post['from_date'])) {
		                       echo $post['from_date']. " ".$post['from_time'];
		                 }else echo date('Y-m-d');
                          
                            echo " To ";

		                 if (!empty($post['to_date'])) {
			                    echo $post['to_date']." ".$post['to_time'];
		                 }else echo date('Y-m-d'); 
		           ?>
			...
			<div class="box box-info">
				...
				<thead>
					<tr class="hide_div"><th><h4><?php echo "FREE PATIENTS"." ".$lang_list; ?> From <?php if (!empty($post['from_date'])) {
			...
			$j=1;
				for($i=0;$i<count($patientInfo);$i++) {?>
					<tr>
						...
						<td>
								<?php if($patientInfo[$i][41] == 1 || $patientInfo[$i][32] == "VISIT" || $patientInfo[$i][58] == 'YES') echo "UNPAID";
									else echo "PAID";?>
									<?php if($patientInfo[$i][58] == 'YES') echo "<span class='text-red' ><small>(Health checkup)</small></span>";?>
									</td>
						</td>
	 ...
	 <input type="hidden" name="page_name" id="patient_report" value="free_patient_report" />
