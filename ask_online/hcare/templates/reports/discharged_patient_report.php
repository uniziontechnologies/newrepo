<?php
    ...
    $ipbillInfo=$this  ->popArr['billInfo'];
...
function submitform(action,id){
		...
		document.patients.id.value=id;
   		document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=discharged_patient_report";
   ...
   function download_pdf(){
   		$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Discharge Patient Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
...
<section class="content-header">
          <h4><?php echo $lang_search." ".$lang_discharged_patient; ?></h4>
		...
		<div class="DONTPrint">				 
			<div class="box box-info">
               ...
               <div class="box-body">
				<table class="table table-striped">
                	...
                	<h3 >
						<?php echo $lang_discharged_patient." ".$lang_list; ?>
			...
			<div class="box box-info">
               ...
               <div class="box-body">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo $lang_discharged_patient." ".$lang_list; ?> From <?php if (!empty($post['from_date'])) {
			...
			$j=1;
				for($i=0;$i<count($patientInfo);$i++) {?>
					<tr>
						...
						<td><?php echo $patientInfo[$i][22];?></td>
...
?>
	  ...
	  <input type="hidden" name="page_name" id="discharged_patient_report" value="discharged_patient_report" />
