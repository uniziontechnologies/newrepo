...
function submitform(action,id){
  ...
  if(action =="CLEAR"){
			...
			document.patients.bill_no.value='';
   		    ...
   		    document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=pharmacy_invoice_report";
   ...
   function download_pdf(){
   	$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Pharma Invoice Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
		...
		<section class="content">
			...
			<div class="box box-info">
               ...
               <div class="box-body">
				...
				<thead>
						<tr class="hide_div"><td>	<h4><?php echo $lang_invoice_report; ?> From <?php if (!empty($post['from_date'])) {
...
?>
	  ...
	  <input type="hidden" name="page_name" id="pharmacy_invoice_report" value="pharmacy_invoice_report" />
