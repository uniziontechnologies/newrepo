...
<div id="wrapper">
			...
			<div id="rightnow">
                	...
                	<div class="reallynow" width="70%" style="margin-left: 2%;margin-right: 28%">	
                	    <h4>ITEMWISE RECEIVINGS REPORT</h4>			
						...
						<table width="70%" border="1" style="margin-left: 2%">
							<thead>
								...
								<th width="15%" class="center"><?php echo $lang_mode; ?></th>
								<th width="15%" class="center"><?php echo $lang_batch; ?></th>
								<th width="10%" class="center"><?php echo $lang_expiry; ?></th>
								<th width="15%" class="center"><?php echo $lang_pack; ?></th>
								<th width="15%" class="center"><?php echo $lang_qty; ?></th>

								<th width="15%" class="center"><?php echo $lang_foc; ?></th>
								<th width="15%" class="center"><?php echo $lang_buyp; ?></th>
								<th width="10%" class="center"><?php echo $lang_discount; ?></th>
						...
						<?php	
								...
								?>
							<tr>
								<td colspan="12" align="right"><b>Toal</b></td>
