...
function submitform(action,id){
  ...
  if(action =="CLEAR"){
			...
			document.patients.bill_no.value='';
   		    ...
   		    document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=pharmacy_discount_report";
   ...
   function download_pdf(){
		...
		$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Invoice Discount Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
...
<section class="content-header">
		...
		<section class="content">
			...
			<div>
			    <div>
                	<h4> 
						<?php echo empty($post) || ($post['paction']=="CLEAR")?$lang_invoice_report." From ".date("d-m-Y")." To ".date("d-m-Y"):$lang_invoice_report." From ".$post['from_date']." ".$post['from_time']." To ".$post['to_date']." ".$post['to_time']; ?>
			...
			<div class="box box-info">
               ...
               <div class="box-body">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo $lang_invoice_report." - ".$lang_discount; ?> From <?php echo $post['from_date']. " ".$post['from_time'];?> To <?php echo $post['to_date']." ".$post['to_time'];?></h4></td></tr>
					<tr>
						...
						<th width="4%" class="center"><a href="#"><?php echo $lang_ip."/".$lang_op." ".$lang_no; ?></a></th><th width="7%" class="center"><a href="#"><?php echo $lang_customer_name; ?></a></th>   		  
                        <th width="4%" class="center"><a href="#"><?php echo $lang_payment_type; ?></a></th>
						<th width="4%" class="center"><a href="#"><?php echo $lang_total; ?></a></th>
					    <th width="4%" colspan="3" class="center"><a href="#"><?php echo $lang_discount; ?></a></th>
						<th width="4%" class="center"><a href="#"><?php echo $lang_net_total; ?></a></th>
					    <th width="4%" class="center"><a href="#"><?php echo $lang_card_amount; ?></a></th>
					    <th width="4%" class="center"><a href="#"><?php echo $lang_upi_amount; ?></a></th>
						<th width="4%" class="center"><a href="#"><?php echo $lang_cheque_amount;?></a></th>
						<th width="2%" class="center"><a href="#"><?php echo $lang_cash_amount;?></a></th>
				...
				for($i=0;$i<count($pharmaInfo);$i++) {?>
					            ...
					            <tr>
										...
										<?php }else if($pharmaInfo[$i][2] == "IP"){?>
										       ...
										       <td><?php echo $pharmaInfo[$i][34];?></td>
										<?php }else{?>
										        <td></td>
										<?php } ?>
										...
										<?php if($pharmaInfo[$i][15] =="CREDIT" || $pharmaInfo[$i][11] !=""){?>
												...
												<td><?php echo $pharmaInfo[$i][10];?></td>
												<td><?php echo $pharmaInfo[$i][11];?></td>
												<td><?php echo $pharmaInfo[$i][12];?></td>
												<td><?php echo $pharmaInfo[$i][13];?></td>
		...
		<?php
		            $total=$total+$pharmaInfo[$i][10];
		            $discount_total=$discount_total+$pharmaInfo[$i][13];
...
?>
	  ...
	  <input type="hidden" name="page_name" id="pharmacy_discount_report" value="pharmacy_discount_report" />
