   ...
   function submitform(action,id){
		...
		if(action =="CLEAR"){
			...
			document.manage_bill.to_time.value='';
   			...
   			document.manage_bill.action="../../lib/controllers/centralController.php?module=Report&sub_module=itemwise_conso_bill_report";
   ...
   function download_pdf(){
   	$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Itemwise Consolidated Billing Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
	...
	<section class="content">
	 <div class="DONTPrint">				 
	   <div class="box box-info">
				...
				<table class="table table-striped">
								...
								<tr>
										...
										<td id="noborder" >	
											...
											<span class="bootstrap-timepicker"><input type="text"  name="from_time" id="from_time" class="timepicker" size="5" value="<?php echo (!empty($post['from_time']))?$post['from_time']:''?>"></span>
										</td>
										...
										<td id="noborder" >	<input type="text" name="to_date" id="to_date"  class="DatePicker" value="<?php echo (!empty($post['to_date']))?date('d-m-Y',strtotime($post['to_date'])):date('d-m-Y');?>" readonly="true" size="10" />
											<span class="bootstrap-timepicker"><input type="text"  name="to_time" id="to_time" class="timepicker" size="5" value="<?php echo (!empty($post['to_time']))?$post['to_time']:''?>"></span>	
			...
			<h4 >CONSOLIDATED <?php echo $lang_bill_report; ?></h4>		
			<div class="box box-info">
				...
				<thead>
					<tr class="hide_div"><td><h4>CONSOLIDATED <?php echo $lang_bill_report; ?> From <?php if (!empty($post['from_date'])) {
...
?>				
	 ...
	 <input type="hidden" name="page_name" id="itemwise_conso_bill_report" value="itemwise_conso_bill_report" />
</form>	  
</body>
	</html>
