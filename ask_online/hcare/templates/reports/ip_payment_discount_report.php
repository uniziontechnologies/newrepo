   ...
   function submitform(action,id){
		...
		if(action == "PRINT"){
  		 ...
  		 if(a==true)
   			...
   			document.manage_bill.action="../../lib/controllers/centralController.php?module=Report&sub_module=ip_payment_discount_report";
		}
   ...
   function download_pdf(){
   	$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Ip Payment Discount Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
...
<section class="content-header">
		...
		<section class="content">
		 <div class="DONTPrint">			 
			...
			<h4 ><?php echo $lang_ip_payments_discount_report; ?>From <?php echo $post['from_date']. " ".$post['from_time'];?> To <?php echo $post['to_date']." ".$post['to_time'];?>
			...
			<div class="box box-info">
               ...
               <div class="box-body">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo $lang_ip_payments_discount_report; ?> From <?php if (!empty($post['from_date'])) {
...
?>
	 ...
	 <input type="hidden" name="paction" id="paction" />
	  ...
	  <input type="hidden" name="page_name" id="ip_payment_discount_report" value="ip_payment_discount_report" />
</form>	  
</body>
	</html>
