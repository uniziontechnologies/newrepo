   ...
   function download_pdf(){
   	$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Doctor Consolidated Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
  ...
  <section class="content-header">
	...
	<section class="content">
	   ...
	   <div class="box box-info">
		...
		<h4 ><?php echo $lang_doctor." ".$lang_report; ?></h4>
			...
			<div class="box box-info">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo $lang_doctor." ".$lang_report; ?> <?php if (!empty($post['from_date'])) {
		echo "From ".$post['from_date'];} if (!empty($post['to_date'])) {
			echo "To ".$post['to_date'];
					...
					<tr>
						 ...
						 <th><a href="#"><?php echo $lang_fresh ?></a></th>
						 <th><a href="#"><?php echo $lang_renew ?></a></th>
						 <th ><a href="#"><?php echo $lang_visit; ?></a></th>
						 <th ><a href="#"><?php echo $lang_revisit; ?></a></th>	
						 <th ><a href="#"><?php echo $lang_free; ?></a></th> 
						 <th ><a href="#"><?php echo $lang_health_checkup; ?></a></th> 
						  <th ><a href="#">Total OP</a></th>	
		...
		$total_op=0;
			...
			$j=1;
				for($i=0;$i<count($doctorInfo);$i++) {?>
					<tr>
						<td><?php echo $j++;?></td>
						<td><a href="#" onclick="doctor_report('<?php echo $doctorInfo[$i][5];?>');"><?php echo $doctorInfo[$i][0];?></a></td>
						<td><?php echo	$doctorInfo[$i][1]?></td>
						<td><?php echo $doctorInfo[$i][6];?></td>
						<td><?php echo $doctorInfo[$i][2];?></td>
						<td><?php echo $doctorInfo[$i][8];?></td>
						<td><?php echo $doctorInfo[$i][3];?></td>
						<td><?php echo $doctorInfo[$i][7];?></td>
						<td><?php echo $doctorInfo[$i][1]+$doctorInfo[$i][6]+$doctorInfo[$i][2]+$doctorInfo[$i][8]+$doctorInfo[$i][3]+$doctorInfo[$i][7];?></td>
		...
		$fresh +=$doctorInfo[$i][1];
		$renew +=$doctorInfo[$i][6];
		$visit +=$doctorInfo[$i][2];
		$revisit +=$doctorInfo[$i][8];
		$free +=$doctorInfo[$i][3];
		$health_checkup +=$doctorInfo[$i][7];
		$lang_fees_collected +=$doctorInfo[$i][4];
		$total_op +=$doctorInfo[$i][1]+$doctorInfo[$i][6]+$doctorInfo[$i][2]+$doctorInfo[$i][8]+$doctorInfo[$i][3]+$doctorInfo[$i][7];
		...
		?>
					...
					<tr>
						...
						<td><b><?php echo round($fresh);?></b></td>
						<td><b><?php echo round($renew);?></b></td>
						<td><b><?php echo round($visit);?></b></td>
						<td><b><?php echo round($revisit);?></b></td>
						<td><b><?php echo round($free);?></b></td>
						<td><b><?php echo round($health_checkup);?></b></td>
						<td><b><?php echo round($total_op);?></b></td>
						<td><b><?php echo round($lang_fees_collected);?></b></td>
	 ...
	 <input type="hidden" name="page_name" id="doctor_consolidated" value="doctor_consolidated" />
