<?php
	...
	$PharmaInvoiceItems=$this  ->popArr['PharmaReceivingsItems'];
...
<script>
   ...
   function submitform(action){
		...
		if(action =="CLEAR"){
			...
			document.receivings_itemwise_report.from_date.value='';
			document.receivings_itemwise_report.to_date.value='';
			document.receivings_itemwise_report.brand.value='';
			
			
		}
		
   		document.receivings_itemwise_report.action="../../lib/controllers/centralController.php?module=Report&sub_module=pharmacy_receivings_itemwise_report";
		
		document.receivings_itemwise_report.submit();
   ...
   function download_pdf(){
   	$('.hide_div').show();
				$(".table2excel").table2excel({
					...
					filename: "Pharma Recievings Itemwise Report",
					fileext: ".xls",
					exclude_img: true,
					exclude_links: true,
					exclude_inputs: true
			...
			$('.hide_div').hide();
		// document.receivings_itemwise_report.action="../../lib/controllers/centralController.php?module=Report&sub_module=download_pdf";
		// document.receivings_itemwise_report.submit();
...
<body id="frame">
<form name="receivings_itemwise_report" id="form"  method="post" action=""> 
	...
	<section class="content">
	 <div class="DONTPrint">				 
	   <div class="box box-info">
        ...
        <div>
            <div>
            	   <h4 ><?php echo $itemwise_receivings_report." From ".$post['from_date']." To ".$post['to_date']; ?></h4>
            </div>
		    <div>
			...
			<div class="box box-info">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo $itemwise_receivings_report; ?> From <?php if (!empty($post['from_date'])) {
			...
			$j=1;
				for($i=0;$i<count($PharmaInvoiceItems);$i++) {?>
					<tr>
						<td><?php echo $j++;?></td>
						<td>
						  <a href="../../lib/controllers/centralController.php?module=Report&sub_module=receivings_itemwise_detailed_report&item_id=<?php echo $PharmaInvoiceItems[$i][3];?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" class="thickbox none" title="VIEW ITEM BILL INFORMATION">
...
<input type="hidden" name="page_name" id="pharmacy_receivings_itemwise_report" value="pharmacy_receivings_itemwise_report" />	 
</form>	  
</body>
	</html>
