...
<script>
   ...
   function submitform(action,id){
		...
		setAction(action,id);
   		document.patients.action="../../lib/controllers/centralController.php?module=Report&sub_module=observation_report";
	...
	<section class="content">
	 <div class="DONTPrint">				 
	   <div class="box box-info">
			...
			<h4 ><?php echo "OBSERVATION"." ".$lang_list; ?> From <?php echo $post['from_date']. " ".$post['from_time'];?> To <?php echo $post['to_date']." ".$post['to_time'];?>
			...
			<div class="box box-info">
				...
				<thead>
					<tr class="hide_div"><td><h4><?php echo "OBSERVATION"." ".$lang_list; ?> From <?php if (!empty($post['from_date'])) {
			...
			echo " To ".$post['to_date']." ".$post['to_time'];
					...
					<tr>
						...
						<th ><a href="#"><?php echo $lang_patient_category; ?></a></th> 
						  ...
						  <th><a href="#"><?php echo "ADMISSION"; ?></a></th>				  <th><a href="#"><?php echo $lang_observation_room; ?></th>
		...
		?>
					...
					<tfoot>
						...
						<td><b><?php echo round($net_total);?></b></td>
