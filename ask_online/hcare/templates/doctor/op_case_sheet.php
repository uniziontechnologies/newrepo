 ...
 $('.main-header', window.parent.document).hide();
  $(document).ready(function(){
	  ...
	  $(".side_menu").bind('click', function() {
        ...
        $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=op_case_sheet&active_module="+active_module);
   	    $("#form").submit();
    });
  ...
  //       $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=save_diabetic_status");
  //  	    $("#form").submit();
  //   });
  ...
  //       $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=save_hyper_tension_status");
  //  	    $("#form").submit();
  //   });
	...
	$("#show_allergies").bind('click', function() {
	  ...
	  var opid=$("#opid").val();
      tb_show('ALLERGIES',"../../lib/controllers/centralController.php?module=Doctor&sub_module=patient_allergies&visit_id="+opid,'',450,250);
    });
...
//         $.ajax({ //alert("sssssss");
//             type: "POST",
//             url: "../../lib/controllers/centralController.php?module=Doctor&sub_module=save_diabetic_status",
//             data: $("#form").serialize(),
//             // beforeSend: function() {
...
//         $.ajax({ //alert("sssssss");
//             type: "POST",
//             url: "../../lib/controllers/centralController.php?module=Doctor&sub_module=save_hyper_tension_status",
//             data: $("#form").serialize(),
//             // beforeSend: function() {
//             //     $('#result').html('<img src="loading.gif" />');
//             // },
...
// })
  ...
  function back_to_list() {
  	...
  	window.location=("../../lib/controllers/centralController.php?module=Doctor&sub_module=OPPatient_list");
  	$('.main-header', window.parent.document).show();
...
?>
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="<?php echo (!empty($post['active_module']) && $post['active_module'] == 'presenting_complaints')?'active':'';?>"><a href="#" class="side_menu" id="presenting_complaints"><i class="fa fa-circle-o"></i> <span><?php echo $lang_presenting_complaints; ?></span> </a></li>

			<!-- <li class="<?php //echo (!empty($post['active_module']) && $post['active_module'] == 'covid_status')?'active':'';?>"><a href="#" class="side_menu" id="covid_status"><i class="fa fa-circle-o"></i> <span><?php //echo 'COVID - 19 Details'; ?></span> </a></li> -->

			<li class="<?php echo (!empty($post['active_module']) && $post['active_module'] == 'patient_physical_exam')?'active':'';?>"><a href="#" class="side_menu" id="patient_physical_exam"><i class="fa fa-circle-o"></i> <span><?php echo $lang_physical_exam; ?></span> </a></li>
	...
	<?php } ?>
            <li class="<?php echo (!empty($post['active_module']) && $post['active_module'] == 'patient_allergies')?'active':'';?>"><a href="#" class="side_menu" id="patient_allergies"><i class="fa fa-circle-o"></i> <span><?php echo $lang_allergies; ?></span> </a></li>
			<li class="<?php echo (!empty($post['active_module']) && $post['active_module'] == 'patient_documents')?'active':'';?>"><a href="#" class="side_menu" id="patient_documents"><i class="fa fa-circle-o"></i> <span><?php echo $lang_documents; ?></span> </a></li>
			...
			<li class="<?php echo (!empty($post['active_module']) && $post['active_module'] == 'view_complete_note')?'active':'';?>"><a href="#" class="side_menu" id="view_complete_note"><i class="fa fa-circle-o"></i> <span><?php echo $lang_view_complete_note; ?></span> </a></li>
...
<div class="wrapper">
	   ...
	   <form name="casesheet" id="form"  method="post" action=""> 
        ...
        <section class="content-header">
		  ...
		  if(!empty($post['active_module']) && $post['active_module'] == 'presenting_complaints'){
			  echo $lang_presenting_complaints; 
		  }else if(!empty($post['active_module']) && $post['active_module'] == 'patient_physical_exam'){
			  echo $lang_physical_exam; 
		  }else if(!empty($post['active_module']) && $post['active_module'] == 'diabetic_analysis'){
			  echo $lang_diabetic_analysis; 
		  }else if(!empty($post['active_module']) && $post['active_module'] == 'patient_allergies'){
			  echo $lang_allergies; 
		  }else if(!empty($post['active_module']) && $post['active_module'] == 'view_complete_note'){
			  echo $lang_view_complete_note; 
		  }else if(!empty($post['active_module']) && $post['active_module'] == 'patient_documents'){
			  echo $lang_documents; 
		  }else if(!empty($post['active_module']) && $post['active_module'] == 'refer_doctor'){
			  echo $lang_reffer; 
		  }
 ...
 <section class="content">
	<div class="row">
	 ...
	 <?php if(!empty($post['active_module']) && $post['active_module'] != 'view_complete_note'){	?>	
	    ...
	    <?php if(!empty($post['active_module']) && $post['active_module'] == 'presenting_complaints'){
	                   
					   include("presenting_complaints.php");
					   
		}elseif(!empty($post['active_module']) && $post['active_module'] == 'patient_physical_exam'){
			  
			  include("patient_physical_exam.php");
		}elseif(!empty($post['active_module']) && $post['active_module'] == 'diabetic_analysis'){
			  
			  include("patient_diabetic_analysis.php");
			  
		}elseif(!empty($post['active_module']) && $post['active_module'] == 'patient_allergies'){
			  
			  include("patient_allergies.php");
		}elseif(!empty($post['active_module']) && $post['active_module'] == 'view_complete_note'){
