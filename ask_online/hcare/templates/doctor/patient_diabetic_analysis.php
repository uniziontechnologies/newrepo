	  ...
	  $(document).ready(function() {  	
	       ...
	       $("#add_reading").bind('click', function() {
			   ...
			   if($("#sugar_level").val() == ""){
		         ...
		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=add_diabetic_reading");
   	             $("#form").submit();
				 return true;
			   }
		  });
          $(".delete_readings").bind('click', function() {
			  ...
			  inline_action="../../lib/controllers/centralController.php?module=Doctor&sub_module=delete_diabetic_reading";
...
<div id="content">
   <div class="box box-info">
				...
				<tr>
				   ...
				   <td> <input name="reading_date" id="reading_date" type="datetime-local"  value=""  autocomplete="off" onkeypress="nextField(event.keyCode,save)" style=" width: 235;">
				   </td>
				</tr>
				    <tr>
