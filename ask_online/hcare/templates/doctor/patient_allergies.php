	  ...
	  $(document).ready(function() {  	
	       ...
	       $("#add_allergy").bind('click', function() {
			   ...
			   if($("#allergic_to").val() == ""){
		         ...
		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=add_patient_allergy");
   	             $("#form").submit();
				 return true;
			   }
		  });
          $(".delete_saved_allergies").bind('click', function() {
			  ...
			  inline_action="../../lib/controllers/centralController.php?module=Doctor&sub_module=delete_patient_allergy";
