<script>
	  ...
	  $(document).ready(function() { 
         ...
         $("#save").bind('click', function() {
		         ...
		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=save_ip_physical_examination");
   	             $("#form").submit();
		  });	
     });	
		  ...
		  <div class="box-body">
		    ...
		    ?>	    
                       <div class="box box-success  box-solid">
                          <div class="box-header with-border">
                             <?php echo date('d-m-Y h:i a',strtotime($examinatHistory[$k][14])) ;?> 
			     ...
			     $examHis=$examinatHistory[$k][0];
				  ...
				  <?php
					   ...
					   <tr >
					     ...
					     <td ><b><?php echo $lang_temp;?></b></td><td><?php echo $examinatHistory[$k][3];?>F</td>
						<td><b><?php echo $lang_pulse;?></b></td><td><?php echo $examinatHistory[$k][4];?>bpm</td>
					 </tr>
					 <tr >
						<td><b><?php echo $lang_bp;?></b></td><td><?php echo $examinatHistory[$k][5];?>(mm/hg)</td>
						<td ><b><?php echo $lang_height;?></b></td><td><?php echo $examinatHistory[$k][6];?>cm</td>
					 </tr>
					 <tr >
						<td><b><?php echo $lang_weight;?></b></td><td><?php echo $examinatHistory[$k][7];?>kgs</td>
						<td><b><?php echo $lang_bmi;?></b></td><td><?php echo $examinatHistory[$k][8];?></td>
					    
					 </tr>
					 <tr >
					   
					     <td colspan="2"><b><?php echo $lang_resp_rate;?></b> <?php echo $examinatHistory[$k][9];?>rpm</td>
					 </tr>
					 <tr >
						<td colspan="2"><b><?php echo $lang_oxy_saturation;?></b> <?php echo $examinatHistory[$k][10];?>%</td>
					 ...
					 <tr>
							...
							<tr>
							  <td colspan="3" ><p><?php echo $examinatHistory[$k][11];?></p>
							  </td>
							 </tr>
