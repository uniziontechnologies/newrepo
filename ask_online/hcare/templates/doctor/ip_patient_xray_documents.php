...
$(document).ready(function() { 
			   ...
			   if($("#document").val() == ""){
		         ...
		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=attach_ip_patient_xray_documents").attr("enctype","multipart/form-data");
   	             $("#form").submit();
				 return true;
			   }
		  });
          ...
          $(".delete_document_files").bind('click', function() {
		         ...
		         var id = $(this).attr('id');
			  	 ...
			  	 $("#hidden_remove").val(id);
			  		         ...
			  		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Doctor&sub_module=delete_ip_patient_xray_document").attr("enctype","multipart/form-data");
   	             			 $("#form").submit();
...
<div id="content">
   <div class="box box-info">
			       ...
			       <table class="table">
			         <tr>
				   <td><?php echo 'Xray '.$lang_documents;?></td>
