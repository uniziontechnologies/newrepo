   ...
   function submitform(action,id){
		...
		if(action == "PRINT"){
  		 ...
  		 if(a==true)
   			...
   			document.manage_bill.action="../../lib/controllers/centralController.php?module=Billing&sub_module=Manage_IP_Credit_Payments";
		}
			...
			$j=1;
				for($i=0;$i<count($billInfo);$i++) {?>
					<tr>
						...
						<td><?php echo $billInfo[$i][2]." ".$billInfo[$i][14];?></td>
						...
						<td><?php echo $billInfo[$i][16];?>
						<td><?php echo $billInfo[$i][6];?>
