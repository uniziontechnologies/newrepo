   ...
   <div id="content" >
 	  ...
 	  <table width ="100%" >
		...
		<table width ="90%"  align="center">
				...
				<tr>
						<td id="noborder">
			 			 <font size="<?php echo $lang_font_size;?>"><?php echo 'MOB'; ?>&nbsp;:&nbsp;<?php echo !empty($billInfo[0][7])?$billInfo[0][7]:'';?></font>
						</td>
			...
			<br>
   					...
   					<table align="center" width="90%" id="datatable" border="1">
						<tr>
							<th><font size="<?php echo $lang_font_size;?>">SL</font></th>
							<th><font size="<?php echo $lang_font_size;?>">PARTICULARS</font></th>
							<th><font size="<?php echo $lang_font_size;?>">AMOUNT</font></th>						
							<th><font size="<?php echo $lang_font_size;?>">QTY</font></th>
							<th><font size="<?php echo $lang_font_size;?>">NET</font></th>
						</tr>
						<?php
							$total=0;
					...
					<?php if($billInfo[0][23] >0) { ?>
						<tr>
 							<td colspan="4" align="right"><font size="<?php echo $lang_font_size;?>"><?php echo $lang_discount; ?></font></td>
  							<td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[0][23];?></font></td>
 						</tr>
					
						<tr>
 							<td colspan="4" align="right"><font size="<?php echo $lang_font_size;?>">NET TOTAL</font></td>
  							<td><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[0][11];?></font></td>
 						</tr>
					<?php } 
					$amount=$billInfo[0][13]+$billInfo[0][15]+$billInfo[0][55];
					?>
 						<tr>
 							<td colspan="4" align="right"><font size="<?php echo $lang_font_size;?>">AMOUNT PAID</font></td>
  							<td><font size="<?php echo $lang_font_size;?>"><?php echo $amount;?></font><br /></td>
 						</tr>
					<?php if($billInfo[0][21] !=0){?>
 						<tr>
 							<td colspan="4" align="right"><font size="<?php echo $lang_font_size;?>">BALANCE</font></td>
					...
					<table align="center" style="margin-left: 70%;margin-top: 1px;"><tr><td width="25%"><font size="<?php echo $lang_font_size;?>">User : </td><td align="left"><font size="<?php echo $lang_font_size;?>"><?php echo $billInfo[0][28];?></font></td></tr>
