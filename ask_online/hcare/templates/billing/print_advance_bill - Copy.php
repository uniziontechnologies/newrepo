   ...
   <div align="left" style="margin-left:80px;"><h1>CHERUVANNUR ,CALICUT</h1>
	 ...
	 <table width ="40%" align="left" >
		...
		<td id="noborder">
				...
				<table width ="80%" align="left">
					...
					<tr>
						...
						<td id="noborder" colspan="2">
			 				<font style="font-family:Verdana, Arial, Helvetica, sans-serif" size="+1"> <?php echo $lang_name; ?>&nbsp;:&nbsp;<?php echo $billInfo[0][8];?></font>
						</td>
				...
				<tr>
						<td id="noborder">
			 				<font style="font-family:Verdana, Arial, Helvetica, sans-serif" size="+1"> <?php echo $lang_room_no; ?>&nbsp;:&nbsp;<?php echo $billInfo[0][9];?></font>
						</td>
						<td id="noborder" align="right">
							<font style="font-family:Verdana, Arial, Helvetica, sans-serif" size="+1"><?php echo $lang_date.":&nbsp;".date("d-m-Y",strtotime($billInfo[0][6]));?></font>
						</td>
				</tr>
		...
		<tr>
			...
			<td id="noborder">
   					...
   					<table width="90%"  align="left">
						...
						<tr>
						     <td><font size="+1">ADVANCE AMOUNT</font></td>
						      <td><font size="+1"><?php echo $billInfo[0][3]+$billInfo[0][4];?></font></td>
						     
						 </tr>
						
 						<tr>
 							<td colspan="1" align="right"><font size="+1">TOTAL</font></td>
  							<td><font size="+1"><?php echo $billInfo[0][3]+$billInfo[0][4];?></font></td>
 						</tr>
