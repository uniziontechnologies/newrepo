...
<style type="text/css">
	@media print{
		@page{
			    size: auto;margin:0mm 90mm 0mm 0mm;
			    /*margin-top: 3cm;*/
			  }
		html,body{
	 ...
	 <!-- 	<tr>
		...
		<table width ="90%"  align="center">
					...
					<tr>
						...
						<td id="noborder">
			 				<font size="<?php echo $lang_font_size;?>"><?php echo $lang_age; ?>&nbsp;:&nbsp;<?php echo $billInfo[0][4]."". $billInfo[0][5];?></font>
						</td>
				...
				<tr>
						<td id="noborder" <?php echo (!empty($patient_category))?'':'colspan="2"'?> >
			 				 <font size="<?php echo $lang_font_size;?>"><?php echo $lang_doctor; ?>&nbsp;:&nbsp;<?php echo $billInfo[0][8];?></font>
						</td>
