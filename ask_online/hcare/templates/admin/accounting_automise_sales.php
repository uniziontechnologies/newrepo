...
$(document).ready(function () {
   ...
   function lock_data(){
   	  ...
   	  var pharma_ledger = $("#pharma_ledger").val();
        ...
        var sales_credit  = $("#sales_credit").val();


   	  if (pharma_ledger=="") {
   		   alert("Please select Pharmacy Collection ledger");
   			return false;
   	  }
   	  else if (cgst_5=="") {
        ...
        else if (sales_credit=="") {
            alert("Please select Sales Credit ledger");
            return false;
        }
   	  else{
				...
				if (a==true) {
					...
					document.daily_collection.action="../../lib/controllers/centralController.php?module=Admin&sub_module=lock_pharmacy_sales_data";
...
?>
 <section class="content">
			...
			<h3>ACCOUNTING AUTOMISE - PHARMACY SALES COLLECTION</h3>
            ...
            <div class="col-md-6 ledgers">
               ...
               <div class="row margin_15">
                  ...
                  <div class="col-md-12">
                        ...
                        <span>Pharmacy Collection</span><br>

                        <select id="pharma_ledger" name="pharma_ledger" <?php if (!empty($accounting_details) && $accounting_details[0][17]==1 ) {
                           echo "disabled";
                        } ?> >
            ...
            <div class="col-md-6 ledgers">
               ...
               <div class="row margin_15">
                  ...
                  <div class="col-md-12">
                        ...
                        <span>Sales Credit (For journal entry)</span><br>

                        <select id="sales_credit" name="sales_credit" <?php if (!empty($accounting_details) && $accounting_details[0][17]==1 ) {
                           echo "disabled";
                        } ?> >
                           <option value="">----- Please Select -----</option>
                        ...
                        <?php
                           ...
                           if (!empty($ledgers)) {
                              ...
                              for ($i=0; $i <count($ledgers) ; $i++) { ?>
                                 ...
                                 <option value="<?php echo $ledgers[$i][0]; ?>" <?php if (!empty($accounting_details) && $accounting_details[0][18]==$ledgers[$i][0] ) {
                                    echo "selected";
                                 } ?> ><?php echo $ledgers[$i][2]; ?></option>
