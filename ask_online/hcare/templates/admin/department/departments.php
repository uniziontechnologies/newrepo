			...
			<div class="box box-info">
               ...
               <div class="box-body">
						<table class="table table-striped">
								...
								<tr>
										<td ><?php echo $lang_department; ?>
											
											<input name="dep_name" id="dep_name" value='' autocomplete="off" />
				...
				<thead>
					<tr>
                         <th ><a href="#"><?php echo $lang_id; ?></a></th>
                                ...
                                <th><a href="#"><?php echo $lang_in_charge; ?></a></th>                                
		...
		<?php
			if(!empty($departmentInfo)){
				for($i=0;$i<count($departmentInfo);$i++) {?>
					<tr>
						<td><?php echo $departmentInfo[$i][0];?></td>
						<td><?php echo $departmentInfo[$i][1];?></td>
						<td><?php echo $departmentInfo[$i][2];?></td>	
						<td><?php echo ($departmentInfo[$i][4] == 0 )?'':$departmentInfo[$i][4]; ?></td>					
						
						<td>
							  <button type="button" class="btn btn-success" onClick="submitform('<?php echo $lang_edit_page;?>','<?php echo $departmentInfo[$i][0];?>');"><i class="fa fa-edit"></i></button>
						   <button type="button" class="btn btn-danger" onClick="submitform('<?php echo $lang_delete;?>','<?php echo $departmentInfo[$i][0];?>');"><i class="fa fa-remove"></i></button>
							</td>
