...
$(document).ready(function () {
   ...
   function lock_data(){
   	    ...
   	    var purchase_medicine = $("#purchase_medicine").val();
        ...
        var bank_ledger   = $("#bank_ledger").val();
          ...
          if (discount=="") {
            ...
            return false;
   		     ...
   		     alert("Please select Bank Ledger ledger");
   			    return false;
   	      }
          else if (purchase_medicine=="") {
           alert("Please select Purchase Medicine ledger");
            return false;
          }
     	    else if (cgst_5=="") {
              ...
              return false;
      				...
      				if (a==true) {
      					...
      					document.daily_collection.action="../../lib/controllers/centralController.php?module=Admin&sub_module=lock_pharmacy_purchase_data_return";
...
?>
 <section class="content">
			...
			<h3>ACCOUNTING AUTOMISE - PHARMACY PURCHASE COLLECTION</h3>
            ...
            <div class="col-md-6 ledgers">
               ...
               <div class="row margin_15">
                  ...
                  <div class="col-md-12">
                        ...
                        <span>Purchase Medicine</span><br>

                        <select id="purchase_medicine" name="purchase_medicine" <?php if (!empty($accounting_details) && $accounting_details[0][17]==1 ) {
                           echo "disabled";
                        } ?> >
            ...
            <div class="col-md-6 ledgers">
               ...
               <div class="row margin_15">
                  ...
                  <div class="col-md-12">
                        ...
                        <span>Bank Account (For credit card purchase)</span><br>

                        <select id="bank_ledger" name="bank_ledger" <?php if (!empty($accounting_details) && $accounting_details[0][17]==1 ) {
                           echo "disabled";
                        } ?> >
                           <option value="">----- Please Select -----</option>
