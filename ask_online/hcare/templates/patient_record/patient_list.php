	...
	<script type="text/javascript" src="../../dist/js/common_functions.js">  </script>
	 ...
	 <script>
	  ...
	  $(".view_patient_record").bind('click', function() {
	      ...
	      $("#id").val($(this).attr("id"));
	      $("#summary").val("summary");
	      $("#form").attr("action","../../lib/controllers/centralController.php?module=Registration&sub_module=View_Patient_Record");
		  $("#form").submit();
	  });
	   $("#search").bind('click', function() {
	  
	      $("#form").attr("action","../../lib/controllers/centralController.php?module=Registration&sub_module=Patient_Records");
		  $("#form").submit();
	  });
               ...
               <div class="box-body">
				...
				<thead>
					<tr>
						...
						<th width="5%"><a href="#"><?php echo $lang_contact_no; ?></a></th>
		...
		<?php
			...
			$j=(($current_page-1)*$perPage)+1;
				...
				?>
					<tr>
						<td><?php echo $j++;?></td>
						<td><?php echo strtoupper($patientInfo[$i][16])."/".$patientInfo[$i][0];?></td>
						...
						<?php } ?>
							...
							<a href="#" class="view_patient_record btn btn-info btn-flat" id="<?php echo $patientInfo[$i][0];?>" >VIEW</a>
