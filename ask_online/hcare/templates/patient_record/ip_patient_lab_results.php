...
$(document).ready(function() { 
	...
	$(".lab_result").bind('click', function() {
	  ...
	  billid=id[1];
      tb_show('LAB RESULT',"../../lib/controllers/centralController.php?module=Lab&sub_module=view_lab_result&billno="+billid,'',800,600);
    });       
   ...
   <div class="box box-info">
			...
			<table class="table table-bordered table-striped">
				<thead>
					<tr>
						...
						<th><a href="#"><?php echo $lang_lab_result; ?></a></th>
                </thead>
				<tbody>	
			...
			<?php if(!empty($resultInfo)){
				    ...
				    for($i=0;$i<count($resultInfo);$i++){ ?>
				    	<tr>
				    	<td><?php echo $j++;?></td>
				    	<td><?php echo $resultInfo[$i][16];?></td>
				    	<td><?php echo $resultInfo[$i][8];?></td>
				    	<td><input type="button" class="btn btn-danger btn-sm lab_result" name="lab_result" id="lab<?php echo $resultInfo[$i][0];?>" value="Lab Result"></td>
				    	</tr>
					<?php  }
			}?>
			</tbody>
