             ...
             <?php
			      ...
			      if(!empty($credit_pharma_item_info)){
					...
					<tr>
						...
						<td><?php echo $credit_pharma_item_info[$i][1];?></td>
						<td><?php echo date('d-m-Y h:i A',strtotime($credit_pharma_item_info[$i][4]));?></td>
						<td><?php echo date('d-m-Y h:i A',strtotime($credit_pharma_item_info[$i][3]));?></td>
						<td><?php echo $credit_pharma_item_info[$i][2];?></td>
