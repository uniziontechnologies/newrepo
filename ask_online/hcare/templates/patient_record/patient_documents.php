...
$(document).ready(function() { 
			   ...
			   if($("#document").val() == ""){
		         ...
		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Registration&sub_module=attach_patient_documents").attr("enctype","multipart/form-data");
   	             $("#form").submit();
				 return true;
			   }
		  });
          ...
          $(".delete_document_files").bind('click', function() {
		         ...
		         var id = $(this).attr('id');
			  	...
			  	$("#hidden_remove").val(id);
			  		         ...
			  		         $("#form").attr("action","../../lib/controllers/centralController.php?module=Registration&sub_module=delete_patient_document").attr("enctype","multipart/form-data");
   	             			 $("#form").submit();
...
<!-- <input type="hidden" name="opno_from_patient_record" id="opno_from_patient_record" value="<?php echo $post['id']; ?>"> -->