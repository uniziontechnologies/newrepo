...
<head>
<title>Unizion Accounting<?php if (isset($page_title)) echo ' | ' . $page_title; ?></title>
...
<div id="container">
	<div id="header">
		<div id="logo">
			<?php echo anchor('', 'Unizion', array('class' => 'anchor-link-b')); ?>
		</div>
		<?php
		...
		<ul class="sf-menu">
			...
			<li>
				<?php
					...
					if ($entry_type_count < 1)
					{
						...
						echo "<ul>";
						echo "<li>" . anchor('entry/show/all/'.$account_fy_start."/".$account_fy_end, 'All', array('title' => 'All Entries')) . "</li>";
						foreach ($entry_type_all as $id => $row)
						{
							echo "<li>" . anchor('entry/show/' . $row['label']."/".$account_fy_start."/".$account_fy_end, $row['name'], array('title' => $row['name'] . ' Entries')) . "</li>";
						}
						echo "</ul>";
					}
				?>
			...
			<li>
				...
				<ul>
					...
					<li><?php echo anchor('report/profitandloss_new', 'Profit & Loss - NEW', array('title' => 'Profit & Loss - NEW')); ?></li>
					<li><?php echo anchor('report/trialbalance/'.$account_fy_start."/".$account_fy_end, 'Trial Balance', array('title' => 'Trial Balance')); ?></li>

					<li><?php echo anchor('report/trialbalance_new/'.$account_fy_start."/".$account_fy_end, 'Trial Balance - NEW', array('title' => 'Trial Balance - NEW')); ?></li>


					<li><?php echo anchor('report/ledgerst/0/'.$account_fy_start."/".$account_fy_end, 'Ledger Statement', array('title' => 'Ledger Statement')); ?></li>
					<li><?php echo anchor('report/reconciliation/pending', 'Reconciliation', array('title' => 'Reconciliation')); ?></li>
					<li><?php echo anchor('report/cashbook/1/'.$account_fy_start."/".$account_fy_end, 'Cash Book', array('title' => 'Cash Book')); ?></li>
					<li><?php echo anchor('report/bankbook', 'Bank Book', array('title' => 'Bank Book')); ?></li>
				</ul>
			</li>
			<li>
...
<div id="footer">
	<?php if (isset($page_footer)) echo $page_footer ?>
		Copyright &copy; <?php echo date("Y"); ?> <a target="_blanck" href="http://uniziontechnologies.com">Unizion Technologies</a>
</div>
</body>
</html>
