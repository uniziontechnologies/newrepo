<?php
	...
	foreach ($tags_q->result() as $row)
	{
		...
		if ($row->id!=1 && $row->id!=2){
			...
			echo anchor('tag/delete/' . $row->id , img(array('src' => asset_url() . "images/icons/delete.png", 'border' => '0', 'alt' => 'Delete Tag', 'class' => "confirmClick", 'title' => "Delete Tag")), array('title' => 'Delete  Tag'));
