...
class General {
	...
	function check_database()
	{
		...
		if ($CI->db->conn_id)
		{
			...
			{
				/* Check for valid Unizion database */
	...
	function check_database_version()
	{
		...
		if ($account_d->database_version < $CI->config->item('required_database_version'))
		{
			...
			$CI->messages->add('You need to updated the application version from <a href="http://uniziontechnologies.com" target="_blank">http://uniziontechnologies.com<a/> before continuing.', 'error');
			redirect('user/account');
			return;
		}
	}
