...
<form name="print_credit_payment" id="print_credit_payment" method="post" action="">
    ...
    <center>   
          ...
          <h4 style="margin-top: -7px"><b><?php echo "TEL : ".$hospitalInfo[0][7]; ?></b></h4>
          <h4 style="margin-top: -7px"><b><?php echo "DL NO : ".$pharmacyInfo[0][3]; ?> , <?php echo "GST NO : ".$pharmacyInfo[0][2]; ?></b></h4>
    </center>
      
          <!-- Main content -->
          <section class="content">
                   <h2 align="center" style="margin-top: -9px;"><b><u>Credit Payment</u></b></h2>
                   <table width="100%">
                    ...
                    <div class="box-body">
					   ...
					   <table width="100%" class="table table-striped table-bordered">
					    ...
					    <tr>
				            ...
				            <th class="font_th"><a href="#">AMOUNT</a></th>
		...
		?>		 
		                <tr>
                             ...
                             <td><?php echo $billInfo[0][3]+$billInfo[0][13]+$billInfo[0][14];?></td>
                        </tr>
                       </table>
					</div>
				</div>
...
function goBack() {
   ...
   document.print_credit_payment.action="<?php echo base_url(); ?>index.php/invoice/manage_credit_payment";
