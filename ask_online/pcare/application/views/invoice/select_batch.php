					    ...
					    <table width="100%" class="table table-striped">
							...
							<?php 
								if(!empty($batch)){						
									...
									<?php if(((!empty($batchInfo)) && in_array($batch[$i][0],$batchInfo))||(!empty($batch_drafted)) && in_array($batch[$i][0],$batch_drafted) ||(!empty($edited_item)) && in_array($batch[$i][0],$edited_item)){ ?>
