<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=purchase_cancelled-report.xls');
  }
...
<form name="cancelled_purchase_report" id="cancelled_purchase_report" method="post" action="">
...
?>
          ...
          <section class="content-header">
            <h1>
                  CANCELLED PURCHASE REPORT
            </h1>
            <div style="text-align: right">
                <button type="button" data-toggle="modal" data-target="#squarespaceModal" class="btn btn-success" onclick="exportPurchaseCancelled()" ><img src="<?php echo base_url(); ?>application/assets/dist/img/Excel-icon.png" width="10%" height="10%"> Export to Excel</button>
            </div>
                    ...
                    <table width="100%" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="font_th"><a href="#">Cancelellation Date</a></th>
                                <th class="font_th"><a href="#">CancelledBy</a></th>
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#cancelled_purchase_report").attr("action","<?php echo base_url(); ?>index.php/reports/purchase_cancelled_report");
                 $("#cancelled_purchase_report").submit();
    });
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      document.cancelled_purchase_report.action="<?php echo base_url(); ?>index.php/reports/purchase_cancelled_report";
      document.cancelled_purchase_report.submit();

    }

    function clearForm(){

        window.location = "<?php echo site_url('reports/purchase_cancelled_report'); ?>";
        return false;
    ...
    function printPurchase(id) {
            ...
            document.cancelled_purchase_report.action='<?php echo base_url(); ?>index.php/purchase/print_purchase';
            document.cancelled_purchase_report.submit();
    ...
    function exportPurchaseCancelled(){

        $("#current_page").val('');
        document.cancelled_purchase_report.action="<?php echo base_url(); ?>index.php/reports/purchase_cancelled_report/export";
        document.cancelled_purchase_report.submit();
