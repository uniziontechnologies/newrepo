<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=h1n_sheduled_x-report.xls');
  }
...
<form name="h1n_shld_x_report" id="h1n_shld_x_report" method="post" action="">
...
?>
          ...
          <section class="content-header">
            <h1 class="main_heading">
                  H1N SHEDULED-X REPORT
            </h1>
            <div style="text-align: right">
                <button type="button" data-toggle="modal" data-target="#squarespaceModal" class="btn btn-success" onclick="exportH1n_shld_x()" ><img src="<?php echo base_url(); ?>application/assets/dist/img/Excel-icon.png" width="10%" height="10%"> Export to Excel</button>
            </div>
                            ...
                            if(!empty($itemInfo)){            
                              ...
                              for($i=0;$i<count($itemInfo);$i++) {?>
                                  <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>index.php/reports/h1n_sheduled_x_detailed_report/<?php echo $itemInfo[$i][3];?>/<?php echo $from_date;?>/<?php echo $end_date;?>/<?php echo $invoice_mode; ?>" 
                                    class="thickbox none" title="View Item Bill Information"><?php echo $itemInfo[$i][0];?></a></td>
...
$(document).ready(function() {
   ...
   function searchForm(){
      ...
      document.h1n_shld_x_report.action="<?php echo base_url(); ?>index.php/reports/h1n_sheduled_x";
      document.h1n_shld_x_report.submit();

    }

    function clearForm(){

        window.location = "<?php echo site_url('reports/h1n_sheduled_x'); ?>";
        return false;
    ...
    function exportH1n_shld_x(){

       document.h1n_shld_x_report.action="<?php echo base_url(); ?>index.php/reports/h1n_sheduled_x/export";
      document.h1n_shld_x_report.submit();
