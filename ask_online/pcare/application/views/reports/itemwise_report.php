<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=invoice_itemwise-report.xls');
  }
...
<form name="itemwise_invoice_report" id="itemwise_invoice_report" method="post" action="">
...
?>
          ...
          <section class="content-header">
            <h1 class="main_heading">
                  ITEMWISE INVOICE REPORT
            </h1>
            <div style="text-align: right">
                <button type="button" data-toggle="modal" data-target="#squarespaceModal" class="btn btn-success" onclick="exportInvoiceItemwise()" ><img src="<?php echo base_url(); ?>application/assets/dist/img/Excel-icon.png" width="10%" height="10%"> Export to Excel</button>
            </div>
                    ...
                    <table class="table table-striped table-bordered" style="margin: 0 auto;width: 50%;margin-top: 15px;">
                            ...
                            if(!empty($itemInfo)){            
                              ...
                              for($i=0;$i<count($itemInfo);$i++) {?>
                                  <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>index.php/reports/itemwise_detailed_report/<?php echo $itemInfo[$i][0];?>/<?php echo $from_date;?>/<?php echo $end_date;?>/<?php echo $invoice_mode; ?>" 
                                    class="thickbox none" title="View Item Bill Information"><?php echo $itemInfo[$i][3];?></a></td>
                                    <td><?php echo $itemInfo[$i][1]; ?></td>
                                    <td><?php echo to_currency($itemInfo[$i][2]); ?></td>           
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td><b><?php echo to_currency($net_total);?></b></td>
...
$(document).ready(function() {
   ...
   function searchForm(){
      ...
      document.itemwise_invoice_report.action="<?php echo base_url(); ?>index.php/reports/itemwise_report";
      document.itemwise_invoice_report.submit();

    }

    function clearForm(){

        window.location = "<?php echo site_url('reports/itemwise_report'); ?>";
        return false;
    ...
    function printInvoice(id) {
            ...
            document.itemwise_invoice_report.action='<?php echo base_url(); ?>index.php/invoice/print_invoice';
            document.itemwise_invoice_report.submit();
    ...
    function exportInvoiceItemwise(){

       document.itemwise_invoice_report.action="<?php echo base_url(); ?>index.php/reports/itemwise_report/export";
      document.itemwise_invoice_report.submit();
