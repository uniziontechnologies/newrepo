<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=hsn_wise_sales-report.xls');
  }
...
<form name="hsn_wise_sales_report" id="hsn_wise_sales_report" method="post" action="">
...
?>
                <h3 id="print_details">
                      ...
                      Hsn Wise Sales Report From <?php echo $from_date; ?> To <?php echo $end_date; ?>
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#hsn_wise_sales_report").attr("action","<?php echo base_url(); ?>index.php/reports/hsnWiseSalesReport");
                 $("#hsn_wise_sales_report").submit();
    });
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      document.hsn_wise_sales_report.action="<?php echo base_url(); ?>index.php/reports/hsnWiseSalesReport";
      document.hsn_wise_sales_report.submit();

    }

    function clearForm(){

        window.location = "<?php echo site_url('reports/hsnWiseSalesReport'); ?>";
        return false;
    ...
    function exporthsnWiseSales(){
       ...
       $("#current_page").val('');
       document.hsn_wise_sales_report.action="<?php echo base_url(); ?>index.php/reports/hsnWiseSalesReport/export";
       document.hsn_wise_sales_report.submit(); 
