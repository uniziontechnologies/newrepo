<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=branchwise-report.xls');
  }
...
<form name="branchwise_invoice_report" id="branchwise_invoice_report" method="post" action="">
...
?>
          ...
          <section class="content-header">
            <h1>
                  BRANCHWISE INVOICE REPORT
            </h1>
            <div style="text-align: right">
                <button type="button" data-toggle="modal" data-target="#squarespaceModal" class="btn btn-success" onclick="exportBranchwise()" ><img src="<?php echo base_url(); ?>application/assets/dist/img/Excel-icon.png" width="10%" height="10%"> Export to Excel</button>
            </div>
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#branchwise_invoice_report").attr("action","<?php echo base_url(); ?>index.php/reports/branchwise_report");
                 $("#branchwise_invoice_report").submit();
    });
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      $("#branchwise_invoice_report"). removeAttr("target");
      document.branchwise_invoice_report.action="<?php echo base_url(); ?>index.php/reports/branchwise_report";
      document.branchwise_invoice_report.submit();

    }

    function clearForm(){

        window.location = "<?php echo site_url('reports/branchwise_report'); ?>";
        return false;
    ...
    function printInvoice(id) {
            ...
            $("#branchwise_invoice_report").attr("target", "_blank");
            document.branchwise_invoice_report.action='<?php echo base_url(); ?>index.php/invoice/print_invoice';
            document.branchwise_invoice_report.submit();
    ...
    function exportBranchwise(){

        $("#current_page").val('');
        document.branchwise_invoice_report.action="<?php echo base_url(); ?>index.php/reports/branchwise_report/export";
        document.branchwise_invoice_report.submit();
    }
