<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=hsn_wise_sales_return-report.xls');
  }
...
<form name="hsn_wise_sales_return_report" id="hsn_wise_sales_return_report" method="post" action="">
...
?>
                <h3 id="print_details">
                      ...
                      Hsn Wise Sales Return Report From <?php echo $from_date; ?> To <?php echo $end_date; ?>
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#hsn_wise_sales_return_report").attr("action","<?php echo base_url(); ?>index.php/reports/hsnWiseSalesReturnReport");
                 $("#hsn_wise_sales_return_report").submit();
    });
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      document.hsn_wise_sales_return_report.action="<?php echo base_url(); ?>index.php/reports/hsnWiseSalesReturnReport";
      document.hsn_wise_sales_return_report.submit();

    }

    function clearForm(){

        window.location = "<?php echo site_url('reports/hsnWiseSalesReturnReport'); ?>";
        return false;
    ...
    function exporthsnWiseSales(){
       ...
       $("#current_page").val('');
       document.hsn_wise_sales_return_report.action="<?php echo base_url(); ?>index.php/reports/hsnWiseSalesReturnReport/export";
       document.hsn_wise_sales_return_report.submit(); 
