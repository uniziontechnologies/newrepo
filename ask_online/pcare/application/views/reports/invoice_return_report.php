...
?>                                            
                        ...
                        <?php
                                        ...
                                        $net_total=$net_total+$billInfo[$i][14];
                                        $cash=$cash+$billInfo[$i][19];
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#invoice_return_report").attr("action","<?php echo base_url(); ?>index.php/reports/invoice_return_report");
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      $("#invoice_return_report"). removeAttr("target");
      document.invoice_return_report.action="<?php echo base_url(); ?>index.php/reports/invoice_return_report";
    ...
    function clearForm(){
        ...
        window.location = "<?php echo site_url('reports/invoice_return_report'); ?>";
        return false;
    ...
    function printInvoice(id) {
            ...
            $('#bill_id').val(id);
            $('#from_path').val("invoice_return_report");
            $("#invoice_return_report").attr("target", "_blank");
    ...
    function viewInvoice(id) {
            ...
            $('#bill_id').val(id);
            $('#from_path').val("invoice_return_report_popup");
    ...
    function exportInvoice(){
        ...
        $("#current_page").val('');
        document.invoice_return_report.action="<?php echo base_url(); ?>index.php/reports/invoice_return_report/export";
        document.invoice_return_report.submit();
    }
