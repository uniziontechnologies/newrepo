...
header('Content-Disposition: attachment; filename=supplier_wise-stock-report.xls');
}
?>
...
<form name="supplier_wise_stock_report" id="supplier_wise_stock_report" method="post" action="">
          ...
          <div class="box box-info DONTPrint">
            ...
            <div class="box-body">
             ...
             Supplier wise Batch Stock Report           
              ...
              $("#supplier_wise_stock_report").attr("action","<?php echo base_url(); ?>index.php/reports/supplier_wise_stock_report");
              $("#supplier_wise_stock_report").submit();
              });
              ...
              $("#current_page").val('');
              $("#supplier_wise_stock_report"). removeAttr("target");
              document.supplier_wise_stock_report.action="<?php echo base_url(); ?>index.php/reports/supplier_wise_stock_report";
              document.supplier_wise_stock_report.submit();
              }
              function clearForm(){
              window.location = "<?php echo site_url('reports/supplier_wise_stock_report'); ?>";
              return false;
              }
              function printInvoice(id) {
              
              $('#bill_id').val(id);
              $('#from_path').val("supplier_wise_stock_report");
              $("#supplier_wise_stock_report").attr("target", "_blank");
              document.supplier_wise_stock_report.action='<?php echo base_url(); ?>index.php/invoice/print_invoice';
              document.supplier_wise_stock_report.submit();
              ...
              $('#bill_id').val(id);
              $('#from_path').val("supplier_wise_stock_report_popup");
              $("#supplier_wise_stock_report"). removeAttr("target");
              ...
              $("#current_page").val('');
              document.supplier_wise_stock_report.action="<?php echo base_url(); ?>index.php/reports/supplier_wise_stock_report/export";
              document.supplier_wise_stock_report.submit();
              }
              </script>