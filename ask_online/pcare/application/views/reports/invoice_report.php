...
<form name="invoice_report" id="invoice_report" method="post" action="">
                                ...
                                if(!empty($billInfo)){                      
                                    ...
                                    for($i=0;$i<count($billInfo);$i++) {?>
                                      ...
                                      <!--   <?php if($billInfo[$i][15] =="CREDIT" || $billInfo[$i][11] !=""){?>
                                                ...
                                                <td><?php echo ($billInfo[$i][37]=='Return')?(-$billInfo[$i][18]):$billInfo[$i][18]; ?></td>
                                                 <td><?php echo ($billInfo[$i][37]=='Return')?(-$billInfo[$i][61]):$billInfo[$i][61]; ?></td>
                                                <td><?php echo ($billInfo[$i][37]=='Return')?(-$billInfo[$i][17]):$billInfo[$i][17]; ?></td>
...
?>                                            
                        ...
                        <?php   
                                        ...
                                        $cash_all=($billInfo[$i][37]=='Return')?(-$billInfo[$i][19]):$billInfo[$i][19];
                                         $card_all=($billInfo[$i][37]=='Return')?(-$billInfo[$i][18]):$billInfo[$i][18];
                                         $upi_all=($billInfo[$i][37]=='Return')?(-$billInfo[$i][61]):$billInfo[$i][61];
                                         $cheque_all=($billInfo[$i][37]=='Return')?(-$billInfo[$i][17]):$billInfo[$i][17];

                                        $net_total=$net_total+$net_total_all;
                                        $cash=$cash+$cash_all;
                                        $card=$card+$card_all;
                                        $checque=$checque+$cheque_all;
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#invoice_report").attr("action","<?php echo base_url(); ?>index.php/reports/invoice_report");
                 $("#invoice_report").submit();
    });
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      $("#invoice_report"). removeAttr("target");
    ...
    function clearForm(){
        ...
        window.location = "<?php echo site_url('reports/invoice_report'); ?>";
        return false;
    ...
    function printInvoice(id) {
            ...
            $("#invoice_report").attr("target", "_blank");
    ...
    function exportInvoice(){
        ...
        $("#current_page").val('');
        document.invoice_report.action="<?php echo base_url(); ?>index.php/reports/invoice_report/export";
        document.invoice_report.submit();
    }
