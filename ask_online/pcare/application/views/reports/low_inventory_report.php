<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=low_inventory-report.xls');
  }
...
<form name="low_inventory_report" id="low_inventory_report" method="post" action="">
...
?>
          ...
          <section class="content-header">
            ...
            <div style="text-align: right">
                <button type="button" data-toggle="modal" data-target="#squarespaceModal" class="btn btn-success" onclick="exportLowInventory()" ><img src="<?php echo base_url(); ?>application/assets/dist/img/Excel-icon.png" width="10%" height="10%"> Export to Excel</button>
            </div>
            ...
            <div class="box box-info DONTPrint">
              ...
              <tr>
                ...
                <td>
                    ...
                    <input name="generic_name" id="generic_name" value="<?php echo !empty($generic_name)?$generic_name:'' ?>" onkeypress="if(event.keyCode== 13){searchForm();}">
                ...
                <td>
                        <select name="branch" id="branch" onkeypress="nextField(event.keyCode,Search);" onchange="searchForm();">
                            <option value="">----------</option>
                            <option value="main_branch" <?php if (isset($branch_selected) && $branch_selected =="0" ) {
                                echo "selected";
                            } ?>>Main Branch</option>
                            <?php
                                if (!empty($branchInfo)) {
                 ...
                 <div class="col-md-9" id="success">
                            <?php  
                              ...
                              if (!empty($generic_name)) {
                                echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Generic Name : ".$generic_name;
                              }
                    ...
                    <table width="100%" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                              ...
                              <th class="font_th"><a href=""><?php echo "Generic Name";?></a></th>
                              <th class="font_th"><a href=""><?php echo "Stock";?></a></th>
                              <th class="font_th"><a href=""><?php echo "Reorder Level";?></a></th> 
                            </tr>
                        </thead>
                          <tbody>
                      ...
                      ?>
                          ...
                          <td><?php echo $brand[$i][2];?></td>
                                 <?php if($branch_selected == 0) {?>              
                          <td><?php echo $brand[$i][3];?></td>
                                 <?php }else{?>             
                          <td><?php echo $brand[$i][4];?></td>
                                 <?php } ?>             
                          <td><?php echo $brand[$i][5];?></td>
                          </tr>             
                      <?php    
                          }
                           }
...
<script type="text/javascript">
 ...
 $(document).ready(function(){
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#low_inventory_report").attr("action","<?php echo base_url(); ?>index.php/reports/low_inventory_report");
                 $("#low_inventory_report").submit();
    });
...
function searchForm(){
      ...
      $("#current_page").val('');
      document.low_inventory_report.action="<?php echo base_url(); ?>index.php/reports/low_inventory_report";
      document.low_inventory_report.submit();

}

function clearForm(){

        window.location = "<?php echo site_url('reports/low_inventory_report'); ?>";
        return false;
...
function exportLowInventory(){
  
    window.open('<?php echo base_url(); ?>index.php/reports/low_inventory_report/export');
