<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=hsn_wise_summary-report.xls');
  }
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#hsn_wise_summary_report").attr("action","<?php echo base_url(); ?>index.php/reports/hsnWiseSummaryReport");
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      document.hsn_wise_summary_report.action="<?php echo base_url(); ?>index.php/reports/hsnWiseSummaryReport";
    ...
    function clearForm(){
        ...
        window.location = "<?php echo site_url('reports/hsnWiseSummaryReport'); ?>";
        return false;
    ...
    function exporthsnWiseSales(){
       ...
       $("#current_page").val('');
       document.hsn_wise_summary_report.action="<?php echo base_url(); ?>index.php/reports/hsnWiseSummaryReport/export";
       document.hsn_wise_summary_report.submit(); 
