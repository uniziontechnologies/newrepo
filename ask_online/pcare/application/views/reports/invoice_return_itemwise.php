<?php
  ...
  if(!empty($export)){
          ...
          header('Content-Disposition: attachment; filename=invoice_return_itemwise-report.xls');
  }
...
?>
          ...
          <section class="content-header">
            <h1>
                  INVOICE RETURN ITEMWISE REPORT
            </h1>
...
$(document).ready(function() {
  ...
  /*......pagination......*/  
    ...
    $(".next_page").bind('click', function() {
                 ...
                 $("#invoice_return_report").attr("action","<?php echo base_url(); ?>index.php/reports/invoice_return_itemwise");
   ...
   function searchForm(){
      ...
      $("#current_page").val('');
      document.invoice_return_report.action="<?php echo base_url(); ?>index.php/reports/invoice_return_itemwise";
    ...
    function clearForm(){
        ...
        window.location = "<?php echo site_url('reports/invoice_return_itemwise'); ?>";
        return false;
    ...
    function exportInvoiceReturn(){
        ...
        $("#current_page").val('');
        document.invoice_return_report.action="<?php echo base_url(); ?>index.php/reports/invoice_return_itemwise/export";
        document.invoice_return_report.submit();
