    ...
    <div class="container"  id="content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="button" name="details" id="details" class="btn btn-success" value="Clearence History" style="    margin-top: 8px;" onclick="show_history();" />
                </div>
              ...
              <div class="box-body">
                ...
                <div class="container" align="center">
                 ...
                 <form method="post" enctype="multipart/form-data">
                  ...
                  <br />
                  <input type="button" name="clear_update" id="clear_update" class="btn btn-danger" value="Clear & Stock Update" style="margin-left: -11%;" />
                  <br><br><br>
...
$(document).ready(function(){
    ...
    $("#clear_update").bind('click', function() {
        ...
        if($.inArray(ext, fileExtension) == -1) {
          ...
          var a = confirm("Please press ok to confirm !");
            ...
            if (a==true) {
             ...
             $("#clear_update").attr('disabled',true);

             document.getElementById("emailSentLoading").style.display="block";
             
              $("#manage_customer").attr("action","<?php echo base_url(); ?>index.php/admin/pharmacy_stock_clear_upload");
    ...
    function show_history(){
        ...
        tb_show('IMPORT HISTORY',"<?php echo base_url(); ?>index.php/admin/show_history/2");
    }

    function tb_remove(){

        document.manage_customer.action='<?php echo base_url(); ?>index.php/admin/pharmacy_stock_clearence';
