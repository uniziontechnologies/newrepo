        ...
        <div class="box box-info">
             ...
             <table width="100%" class="table table-striped table-bordered">
              ...
              <tr>
                    ...
                    <th class="font_th"><a href="#">NEFT Paid</a></th>
...
$(document).ready(function() {
    ...
    $(".next_page").bind('click', function() {
          ...
          $("#manage_credit_payment").attr("action","<?php echo base_url(); ?>index.php/purchase/manage_purchase_credit_payment");
...
function searchForm(){
    ...
    $("#current_page").val('');
    document.manage_credit_payment.action="<?php echo base_url(); ?>index.php/purchase/manage_purchase_credit_payment";
...
function clearForm(){
    ...
    window.location = "<?php echo site_url('purchase/manage_purchase_credit_payment'); ?>";
    return false;
...
function printCreditPayment(id){
   ...
   document.manage_credit_payment.action='<?php echo base_url(); ?>index.php/purchase/print_purchase_credit_payment';
   document.manage_credit_payment.submit();
    ...
    if(v) {
      ...
      var details=prompt("Please Enter Cancellation Details:","");
        ...
        if(details!= null){
          ...
          document.manage_credit_payment.action='<?php echo base_url(); ?>index.php/purchase/delete_purchase_credit_payment/'+id;
          document.manage_credit_payment.submit();
          return true;
