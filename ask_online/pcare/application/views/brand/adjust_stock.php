			 ...
			 <div class="col-md-12">
                ...
                <tr>
                     ...
                     <td>
                        ...
                        <input id="button1" type="button" name="Update" class="btn btn-success"  value="Consume" onclick="return submitForm()"/>
                      ...
                      <input type="hidden" name="brand_post" value="<?php echo $brand_post; ?>">
...
function submitForm(){
      ...
      if( qty=='' ) {
        ...
        return false;   
	      ...
	      document.adjust_stock.action="<?php echo base_url(); ?>index.php/brand/stock_adjust_update";
